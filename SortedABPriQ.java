...
protected T[] elements;           // array to hold priority queues 
elements
protected int numElements = 0;    // number of elements in this priority 
queue
...
while ((index > 0) && (comp.compare(elements[index - 1], element) > 
0))
{
...
//*** Task #1: implement method renqueue(T element) in 
which elements are added in reverse order
...
throw new PriQUnderflowException("dequeue attempted on an empty 
priority queue.");
}
public int size()
...
// Returns true if this priority queue is empty; otherwise, returns 
false.
{
...
// Returns a nicely formatted string that represents this priority 
queue.
{
String temp = "\nPriority Queue: \n";
for (int i = 0; i < numElements; i++)
